...
class CombatEffectSyncTests(unittest.TestCase):
    ...
    def test_client_has_remote_replay_paths_for_every_combat_visual(self):
        ...
        self.assertIn("STRUCTURAL_FIRE_NODE_FUSE_MS = 1000", source)
        self.assertIn("STRUCTURAL_FIRE_NODE_PLANT_STEP_MS = 120", source)
        self.assertIn("STRUCTURAL_FIRE_NODE_MAX_PER_SEGMENT = 8", source)
        self.assertNotIn("STRUCTURAL_FIRE_PATH_DELAY_MS", source)
