(function (global) {
  ...
  const MAIN_CHARACTER = {
    ...
    assets: {
      ...
      attackAmethyst: "assets/sprites/lina-sprites-v10-anchored-expanded.png",
  ...
  const WEAPONS = [
    {
      ...
      attackSheet: "assets/sprites/lina-sprites-v10-anchored-expanded.png",
      projectileFrame: 0,
      impactFrame: 3,
      projectileOrigin: { x: 236 / 362, y: 209 / 362 },
    ...
    },
    {
      ...
      projectileFrame: 4,
      impactFrame: 7,
      projectileOrigin: { x: 232 / 362, y: 191 / 362 },
      projectileScale: 0.15,
      speed: 540,
      size: 16,
      range: 820,
    ...
    },
    {
      ...
      projectileFrame: 8,
      impactFrame: 11,
      projectileOrigin: { x: 235 / 362, y: 159 / 362 },
      projectileScale: 0.15,
      speed: 760,
      size: 10,
      range: 980,
